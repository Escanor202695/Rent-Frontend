          ...
          <div className="row log-in">
            ...
            <div className="col-xl-9 col-lg-8 col-12">
              <div className="theme-card">
                <h2>Privacy policy for ashole property</h2>
                <div className="terms-wrap">
                  <div className="terms-wrapper">
                    <p>
                      At ashole property, accessible at ashole property.com, one
                      of our main priorities is the privacy of our visitors.
                      This Privacy Policy document contains types of information
                      that is collected and recorded by ashole property and how
                      we use it.
                    </p>
                    <p>
                  ...
                  <div className="terms-wrapper" id="thirdparty">
                    ...
                    <p>
                      ashole property's Privacy Policy does not apply to other
                  ...
                  <div className="terms-wrapper" id="advertising">
                    ...
                    <p>
                      ...
                      each of the advertising partners of ashole property.
                    </p>
                    <p>
                      ...
                      Website Name, which are sent directly to users' browser.{" "}
                    </p>
                    <p>
                      Note that ashole property has no access to or control over
