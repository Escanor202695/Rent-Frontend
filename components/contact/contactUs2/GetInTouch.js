            ...
            <div className="row contact-detail theme-card">
              <Col lg="12" className="p-0">
                <div className="contact-content">
                  <h2>Welcome to ashole property !!</h2>
                  <p className="font-roboto">
                    Connected residences might be owned by a single entity and
                    leased out, or owned separately with an agreement covering
                    the relationship between units and common areas and
                    concerns.
                  </p>
                </div>
              </Col>
              ...
              <Col sm="6" className="p-0">
                <div className="contact_wrap shadow-none text-start ps-0">
                  ...
                  <ul>
                    <li>Inquiries: ashole property@.in</li>
