                    ...
                    <ul>
                      ...
                      <li className="with-link">
                        <div className="media">
                          ...
                          <div className="media-body">
                            <h6>
                              <a>https://www.ashole property.com</a>
                            </h6>
                          </div>
                        </div>
                      </li>
              ...
              <Row>
                <Col sm="4">
                  <p className="font-roboto">
                    ...
                    residences and land. Different types of housing tenure can
                    be used for the same physical type.
                  </p>
                </Col>
                <Col sm="4">
                  <p className="font-roboto">
                    Connected residences owned by a single entity leased out, or
                ...
                <Col sm="4">
                  <p className="font-roboto">
                    ...
                    or multifamily structure that is available for occupation or
