...
const SinglePropertySection = ({ data }) => {
  ...
  return (
    <div className="desc-box">
      ...
      <TabContent id="tabsContent" className="tab-content" activeTab={active}>
        <TabPane tabId="About">
          <AboutDeskBox data={data?.description}/>
        </TabPane>
        <TabPane tabId="Features">
          <FeatureDeskBox data={data} />
        </TabPane>
        <TabPane tabId="Video">
          <VideoDeskBox />
        </TabPane>
        <TabPane tabId="Details">
          <DetailsDeskBox data={data} />
        </TabPane>
        <TabPane tabId="Floor Plan">
          <FloorPlanDeskBox image={data?.floorPlan || null} />
        </TabPane>
