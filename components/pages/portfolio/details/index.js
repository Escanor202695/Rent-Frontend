      ...
      <Container>
          ...
          <Col lg="6">
            <div className="details-right">
              <div>
                <h3>About Project</h3>
                <p>
                  Residences can be classified by and connected to neighbouring
                  residences and land. Residences can be classified by and
                  connected to neighbouring residences and land. Residences can
                  be classified by and connected to neighbouring residences and
                  land.
                </p>
        ...
        <Gallery>
          <Row className=" portfolio-section zoom-gallery-multiple gy-md-4 gy-3 ratio_square">
            {data
              ?.slice(4 * grid.toPage - 4, grid.toPage * 4)
              .map((data, i) => (
