...
const HomeBannerSection = () => {
  return (
    <section className="home-section layout-1 layout-6 customer-home" style={{overflow:"hidden"}}>
                  ...
                  <div>
                    ...
                    <NoSsr>
                      <Slider
                        ...
                        {...homeSlider1}
                      >
                        <HomeSliderContent mainTitle="Service You Deserve  People You Trust" />
                      </Slider>
                    </NoSsr>
              ...
              <div className="home-search-6">
                <div className="vertical-search">
                  <div className="left-sidebar">
                    <InputForm lastSm="6" reset={false}/>
                  </div>
                </div>
              </div>
            </Col>
